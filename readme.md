...
gfsh>deploy --jar build\libs\gemfire-stat-logger-0.2.0.jar
...
gfsh>execute function --id=StatLogger --arguments="interval 5000"
Member  | Status | Message
------- | ------ | -------------------------------
server1 | OK     | [Timer interval set to 5000 ms]
server2 | OK     | [Timer interval set to 5000 ms]

gfsh>execute function --id=StatLogger --arguments="no command" 
Member  | Status | Message
------- | ------ | --------------
